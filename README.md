...
- **code**  
    - **algorithms**  
        ...
        - **breadth_first.py**   
            deze file bevat een implementatie van de breadth-first algoritme. De runtime van deze code is te langzaam om in een redelijke tijd met een oplossing voor de boarden te komen. De breath-first met prooning algoritme werd met behulp van deze code geschreven. 
        - **end_point.py**  
